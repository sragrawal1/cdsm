(function () {
    'use strict';
    cdsmApp.controller('corelogController', function corelogController($scope, globalService, commonService, helperService, $rootScope, $timeout) {
        ...
        function onChange(e) {
            try {
               ...
               // kendoConsole.log(message);
                ...
                var x = document.getElementById("coreOptions");
