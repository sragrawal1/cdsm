(function () {
    'use strict';
    cdsmApp.controller('ranlogController', function ranlogController($scope, globalService, commonService, helperService, $rootScope, $timeout) {
        ...
        function onChange(e) {
            try {
               ...
               // kendoConsole.log(message);
                ...
                //$('#ranOptions').append($('<option>', {
                //    value: 1,
                //    text: message
                //}));

                var x = document.getElementById("ranOptions");
        ...
        function loadLogData() {
            ...
            logData.push({
                identifier: "RANKPIs", text: "Processing RAN KPIs", interval: 1,
                data: [
                    'Accessibility',
                    'Retainability',
                    'Monbility',
            ...
            logData.push({
                identifier: "EvaluateProblemCategories", text: "Evaluate Problem Categories", interval: 1,
                data: [
            ...
            logData.push({
                identifier: "FinalizingErrordomains", text: "Finalizing Error domains", interval: 1,
                data: [
                    'RAN  Problem Found - 2',
                    'EPC Problem Found-5',
            ...
            logData.push({
                identifier: "PerformingCrossdomainanalytics", text: "Performing Cross domain analytics", interval: 1,
                data: [
